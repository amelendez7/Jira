...
const UserListPage: FC = function () {
    ...
    useEffect(() => {
        axios.get('https://bn.glassmountainbpo.com:8080/gift/users')
...
const AddUserModal: FC = function () {
    ...
    const handleSubmit = async (e: React.FormEvent, id_rol: any, id_job: any) => {
        e.preventDefault()
        try {
            const response = await axios.post('https://bn.glassmountainbpo.com:8080/gift/save', {
                badge,
                username,
                password,
                id_rol,
...
const EditUserModal: FC<any> = function ({ badge, username, userDepartment, userPosition, status, created_user, id_rol, email, role, sharedState, updateSharedState }: any) {
   ...
   // const [username2, setUsername2] = useState<any>('');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        username = username;
        try {
            const response = await axios.post('https://bn.glassmountainbpo.com:8080/gift_ad/edit', {
                badge,
                username,
                password,
                id_rol,
...
const DeleteUserModal: FC<any> = function ({ badge, status, created_user, sharedState, updateSharedState }: any) {
    ...
    const handleSubmit = async (e: React.FormEvent, badge: any, status: any, created_user: any) => {
        e.preventDefault()
        try {
            const response = await axios.post('https://bn.glassmountainbpo.com:8080/gift/status', {
                badge,
                status,
                created_user
            })
...
const DeleteUsersModal: FC<any> = function ({ users, created_user, sharedState, updateSharedState }) {
    ...
    const handleSubmit = async (e: React.FormEvent, dataToSend: string, created_user: any) => {
        e.preventDefault()
        try {
            const response = await axios.post('https://bn.glassmountainbpo.com:8080/gift/deactivateUsers', {
                dataToSend,
                created_user
            })
            if (response.status == 200) {
...
const ActivateUsersModal: FC<any> = function ({ users, created_user, sharedState, updateSharedState }) {
    ...
    const handleSubmit = async (e: React.FormEvent, dataToSend: string, created_user: any) => {
        e.preventDefault()
        try {
            const response = await axios.post('https://bn.glassmountainbpo.com:8080/gift/activateUsers', {
                dataToSend,
                created_user
            })
            if (response.status == 200) {
